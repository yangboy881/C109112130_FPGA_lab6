...
#set_property -dict {PACKAGE_PIN N15 IOSTANDARD LVCMOS33} [get_ports IN_left]
set_property -dict {PACKAGE_PIN R18 IOSTANDARD LVCMOS33} [get_ports IN_right]

set_property -dict {PACKAGE_PIN U14 IOSTANDARD LVCMOS33} [get_ports {Mux2_pinpon_out[7]}]
set_property -dict {PACKAGE_PIN U19 IOSTANDARD LVCMOS33} [get_ports {Mux2_pinpon_out[6]}]
set_property -dict {PACKAGE_PIN W22 IOSTANDARD LVCMOS33} [get_ports {Mux2_pinpon_out[5]}]
set_property -dict {PACKAGE_PIN V22 IOSTANDARD LVCMOS33} [get_ports {Mux2_pinpon_out[4]}]
set_property -dict {PACKAGE_PIN U21 IOSTANDARD LVCMOS33} [get_ports {Mux2_pinpon_out[3]}]
set_property -dict {PACKAGE_PIN U22 IOSTANDARD LVCMOS33} [get_ports {Mux2_pinpon_out[2]}]
set_property -dict {PACKAGE_PIN T21 IOSTANDARD LVCMOS33} [get_ports {Mux2_pinpon_out[1]}]
set_property -dict {PACKAGE_PIN T22 IOSTANDARD LVCMOS33} [get_ports {Mux2_pinpon_out[0]}]

set_property -dict {PACKAGE_PIN F22 IOSTANDARD LVCMOS33} [get_ports {Sel_IN}]
set_property -dict {PACKAGE_PIN G22 IOSTANDARD LVCMOS33} [get_ports {Sel_CH}]
...
#set_property PACKAGE_PIN U10  [get_ports {seg7_out[5]}] #A
#set_property PACKAGE_PIN U9   [get_ports {seg7_out[6]}] #B
#set_property PACKAGE_PIN AA12 [get_ports {seg7_out[1]}] #C
#set_property PACKAGE_PIN W12  [get_ports {seg7_out[2]}]
#set_property PACKAGE_PIN V12  [get_ports {seg7_out[3]}]
#set_property PACKAGE_PIN U11  [get_ports {seg7_out[4]}]
#set_property PACKAGE_PIN U12  [get_ports {seg7_out[7]}]

## HDMI Output
#set_property PACKAGE_PIN Y9 [get_ports {CLK}];  # "GCLK"
#set_property -dict {PACKAGE_PIN T18 IOSTANDARD LVCMOS25} [get_ports {Reset}]
#set_property -dict {PACKAGE_PIN F22 IOSTANDARD LVCMOS25} [get_ports {SW}]
